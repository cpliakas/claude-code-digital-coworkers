...
description: "Produce a structured retrospective document from a sprint or body-of-work description. Follows the Derby-Larsen five-phase framework with blameless framing and SMART action items."
user-invokable: true
context: fork
...
- Identify any patterns across prior retrospectives if retrospective artifacts exist in the project
...
- Each action item must trace back to a specific insight from Step 5.
