...
| Type | Name | Description |
|------|------|-------------|
| Agent | `devops-specialist` | Infrastructure team lead — CI/CD, deployment strategies, environment management |
| Agent | `aws-specialist` | AWS Well-Architected Framework — service selection, cost optimization, security posture |
...
1. **Strategic lead** — sets principles, tool-agnostic (e.g., `devops-specialist`)
2. **Domain specialist** — applies a specific technology (e.g., `aws-specialist`)
